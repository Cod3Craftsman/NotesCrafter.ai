...
function Pricing() {
  ...
  return (
    <div className='min-h-screen bg-gray-100 px-6 py-10 relative'>
      <button onClick={() => navigate("/")} className='cursor-pointer flex items-center gap-2 text-gray-600 hover:text-black mb-6'>🔙 Back</button>
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <PricingCard
          ...
          features={[
            ...
            "Extra credits for more questions",
            "Charts & Diagrams",
    ...
    >
      ...
      <button disabled={isPayingThisCard} onClick={(e) => {
        ...
        onBuy(amount)
          ...
          w-full mt-5 py-2 rounded-lg font-medium transition ${isPayingThisCard ? "bg-gray-300 cursor-not-allowed" : isSelected ? "bg-black text-white" : "bg-indigo-600 text-white hover:bg-indigo-700"}
        `}>
