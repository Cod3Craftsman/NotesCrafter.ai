...
function SideBar({ result }) {
  ...
  return (
    <div className='bg-white rounded-2xl border border-gray-200 shadow-lg p-5 space-y-6'>



      <div className='flex items-center gap-2'>
        <span className='text-xl'>📌</span>
        <h3 className='text-lg font-bold text-indigo-600 '>Quick Exam View</h3>
      </div>
      ...
      <section className='rounded-lg bg-yellow-50 border border-yellow-200 p-3'>
        ...
        <div className='mb-4 rounded-lg bg-purple-50 border border-purple-200 p-3'>
          <p className='text-sm font-bold text-indigo-700 mb-2'>Long Questions</p>
